...
export const saveSimaiChart = method("saveSimaiChart"); export const getSimaiChart = method("getSimaiChart"); export const countSimaiChartsByOwner = method("countSimaiChartsByOwner"); export const pruneSimaiCharts = method("pruneSimaiCharts"); export const deleteSimaiChart = method("deleteSimaiChart");
