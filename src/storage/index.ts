...
export const saveSimaiChart = method("saveSimaiChart"); export const getSimaiChart = method("getSimaiChart"); export const listRegistryCharts = method("listRegistryCharts"); export const countSimaiChartsByOwner = method("countSimaiChartsByOwner"); export const pruneSimaiCharts = method("pruneSimaiCharts"); export const deleteSimaiChart = method("deleteSimaiChart");
