...
export const GIF_CLIENT_JS = [
  ...
  "    var dur = Math.min(60, Math.max(1, parseFloat(document.getElementById('gDur').value) || 6));",
  "    var size = parseInt(document.getElementById('gSize').value, 10) || 400;",
  "    var fps = parseInt(document.getElementById('gFps').value, 10) || 15;",
  "    return { startMs: start * 1000, durationMs: dur * 1000, size: size, fps: fps,",
  ...
  "        + '&size=' + o.size + '&fps=' + o.fps + '&speed=' + o.speed + '&mirror=' + (o.mirror?'1':'0') + '&guide=' + (o.guide?'1':'0');",
...
export const GIF_RANGE_JS = [
  ...
  "  var MAXLEN = Math.min(60000, dur), MINLEN = Math.min(1000, dur);",
