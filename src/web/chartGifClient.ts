...
const WORKER_LOOP = [
  ...
  "    self.sound = false;",
  "    self.speedIdx = opts.speed; self.mirror = opts.mirror; self.guide = opts.guide; self.interfere = opts.interfere;",
...
export const GIF_CLIENT_JS = [
  ...
  "      speed: speedIdx, mirror: !!mirror, guide: !!guide, interfere: !!interfere };",
  "  }",
  "  mk.onclick = function(){",
  ...
  "        + '&size=' + o.size + '&fps=15&speed=' + o.speed + '&mirror=' + (o.mirror?'1':'0') + '&guide=' + (o.guide?'1':'0') + '&interfere=' + (o.interfere?'1':'0');",
